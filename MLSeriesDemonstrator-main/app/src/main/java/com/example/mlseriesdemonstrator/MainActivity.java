...
public class MainActivity extends AppCompatActivity implements AlgoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Add only Flower Identification option
        arrayList.add(new Algorithm(R.drawable.baseline_filter_vintage_black_48, "Flower Identification", FlowerIdentificationActivity.class));
    ...
    @Override
    public void onAlgoSelected(Algorithm algo) {
...
class AlgoAdapter extends RecyclerView.Adapter<AlgoViewHolder> {
    ...
    public AlgoAdapter(List<Algorithm> algoList, AlgoListener listener) {
...
class AlgoViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void bind(Algorithm algo) {
        this.algo = algo;
...
class Algorithm<T> {
    ...
    public Algorithm(int iconResourceId, String algoText, Class<T> activityClazz) {
...
interface AlgoListener {
    void onAlgoSelected(Algorithm algo);
}
